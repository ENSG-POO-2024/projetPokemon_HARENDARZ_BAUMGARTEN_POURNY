...
class joueur:
    ...
    def deplacement(self, direction):
        ...
        if direction == "up":
            if x == 0:
                if self.case.area_id == 0:
                    self.case.area_id = 2
                    self.case.x = 71
                    self.case.y = 42
                elif self.case.area_id == 3:
                ...
                case_bis = c.Case(x-1,y,self.case.area_id)
                if case_bis.type_case(self.map) != "obstacle":
                    self.case = case_bis
        if direction == "down":
            if x == 71 and self.case.area_id != 0:
                if self.case.y >= 4 and self.case.y <= 7:
                    self.case.area_id = 3
                    self.case.x = 0
                    self.case.y = 41
                elif self.case.y >= 16 and self.case.y <= 19:
                    self.case.area_id = 3
                    self.case.x = 0
                    self.case.y = 53
                else:
                    ...
                    self.case.x = 0
                    self.case.y = 29
            elif not( x == 51 and self.case.area_id == 0):
                case_bis = c.Case(x+1,y,self.case.area_id)
                if case_bis.type_case(self.map) != "obstacle":
                    self.case = case_bis
        if direction == "left":
            if y == 0:
                ...
                case_bis = c.Case(x,y-1,self.case.area_id)
                if case_bis.type_case(self.map) != "obstacle":
                    self.case = case_bis
        if direction == "right":
            if y == 59:
